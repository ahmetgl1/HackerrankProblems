...
Consider the series of numbers beginning
at start and running up to but not including end,
...
version since you have to allocate and index into an array instead of just printing, and we vary the start/end
...
public class FizzBuzz {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(fizzBuzz(0, 20)));
    ...
    public static String[] fizzBuzz(int start , int end){
        ...
        String[] fizzBuz = new String[end - start];
